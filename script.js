...
Дякуємо за ваш запит. Дуже просимо скасувати ваше замовлення або в особистому кабінеті (Замовлення №${order.orderNumber}), або ж можете скасувати замовлення за посиланням: ${url}
